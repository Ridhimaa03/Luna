...
st.sidebar.title("Instructions For LUNA")
...
var2 = ['I was created by Ridhimaa Thakur', 'Ridhimaa Thakur']
...
def get_top_news(api_key):
    try:
        ...
        params = {
            ...
            'pageSize': 6  # Fetch the top 5 headlines
        }
